...
public class B_DataType {
	...
	public static void main(String[] args) {
		// 데이터 타입 (자료형, DataType)
		// : 자바는 강 타입 언어로, 모든 변수 선업 시 데이터 타입을 명시
...
//		2-1. 정수 타입 (8비트 == 1바이트)
//		byte : 8비트 정수 - 값의 범위 (-128 ~ 127) 
//		short : 16비트 정수 - 값의 범위 (-32,768 ~ 32,767)
...
//		long 데이터 타입은 숫자 뒤에 알파벳 L 또는 l을 써서 long형임을 표시
		long apartmentPrice = 1000000000;
...
//		2-3. 실수형 (부동소수점 타입) : 소수점 처리가 있는 수
//		float : 4바이트 소수점. 숫자 뒤에 알파벳F를 써서 float형임을 표시
...
//		: 실제 값을 받는 것이 아닌 데이터가 저장된 메모리의 '주소' 값을 가지는 자료형
//		- 종류
//		  : String 문자열을 저장하는 데에 사용되는 참조 자료형
